...
NB_MODULE(_core, m) {
        ...
        nb::class_<PauliString<std::complex<double>>>(m, "PauliString", "Represents a Pauli string in binary symplectic form.")
                ...
                .def_static("to_complex", &PauliString<std::complex<double>>::to_complex, "Parse SymEngine expression into complex number")
        ...
        nb::class_<PauliString<SymEngine::Expression>>(m, "PauliStringSym", "Represents a Pauli string in binary symplectic form.")
                ...
                .def_static("to_complex", &PauliString<SymEngine::Expression>::to_complex, "Parse SymEngine expression into complex number")
